...
type: 'component'
status: 'stable'
slug: /components/checkbox-field/
github: 'https://github.com/contentful/forma-36/tree/master/packages/forma-36-react-components/src/components/CheckboxField'
storybook: 'https://f36-storybook.contentful.com/?path=/story/form-elements-checkboxfield--basic'
---
...
```jsx
// import {CheckboxField} from '@contentful/f36-components';
...
Light label example - `isLabelLight` changes label font weight to regular. Please keep in mind to not use it with helper text. For that case the medium label has to be used to ensure that there's enough contrast.
