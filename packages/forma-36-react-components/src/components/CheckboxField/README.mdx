...
## Best practices
 ...
 - Checkboxes should work independently, checking one should not affect any other checkbox in the interface. For single choice, please consider using [RadioButton](../RadioButton/RadioButton.tsx)
