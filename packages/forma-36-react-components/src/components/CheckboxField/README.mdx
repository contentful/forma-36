...
CheckboxField is a component that gives an possiblity to easy setup proper checkbox with it's label. Component contains also an options that allows to set helper text displayed below the label. You might see checkboxes in forms, they might be also used for filtering data on the page or terms and conditions. Everywhere where user have multiple choice you might want to use this component.
