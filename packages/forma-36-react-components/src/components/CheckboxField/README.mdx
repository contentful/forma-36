...
CheckboxField is containing a checkbox with its label. Use this component to give users the possibility to select multiple elements. It might be used in forms, for filtering data on the page or terms and conditions. For a single choice, please consider using RadioButton component. 
