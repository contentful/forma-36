...
CheckboxField is containing a checkbox with its label. Use this component to give users the possibility to select multiple elements, zero, one or more items. It can be used in forms or terms and conditions. For a single choice, please consider using RadioButton component. 
