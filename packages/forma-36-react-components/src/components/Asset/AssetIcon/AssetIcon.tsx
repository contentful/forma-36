...
import { Illustration, IllustrationProps, IllustrationType, isIllustrationType } from "../../Illustration/Illustration";
...
export type AssetIconProps = {
  type?: AssetType
} & Omit<IllustrationProps, 'illustration'> & typeof defaultProps
...
export class AssetIcon extends Component<AssetIconProps> {
  ...
  render () {
    ...
    return (<Illustration illustration={illustrationName as IllustrationType} {...otherProps} />);
  }
}
