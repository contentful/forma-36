...
Layout supports both left and right sidebars. If you only need one, use leftSidebar or rightSidebar.
For advanced use cases, refer to the Layout examples and Layout documentation.
