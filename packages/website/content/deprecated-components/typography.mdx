...
`Typography` component was removed in version 4, for more information, [see the detailed migration guide](https://github.com/contentful/forma-36/blob/forma-v4/MIGRATION.md#how-to-migrate-your-typography-components).
