...
`Typography` component was removed in version 4, for more information, [see the detailed migration guide](https://github.com/contentful/forma-36/blob/master/MIGRATION.md#how-to-migrate-your-typography-components).
