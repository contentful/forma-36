...
- Fixing issues and bugs in **existing** components in [v3](https://v3.f36.contentful.com/).
  ...
  - Community [Slack on the channel](https://join.slack.com/t/contentful-community/shared_invite/zt-f2u3vjyq-k2G7wu_ji4~Toywt955Ynw)) #forma36
...
- Contentful will not deactivate any API elements, so we would not expect any sudden failure of any apps that use Forma 36 [v3](https://v3.f36.contentful.com/)
- We will not be able to release bug fixes or updates for Forma 36 [v3](https://v3.f36.contentful.com/) components. This means that in order to resolve any issues that arise, users may be required to update to v4.
