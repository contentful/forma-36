...
**We will continue to support [v3](https://v3.f36.contentful.com/) until 12th July 2022 (A six month transition period). Until 12th July 2022 Contentful will continue to support Forma 36 v 3. This support will entail:**
...
- Contenful will not deactivate any API elements, so we would not expect any sudden failure of any apps that use Forma 36 [v3](https://v3.f36.contentful.com/)
