...
No. There are no major visual changes in version 4, so there is no need to redesign your apps. Use [our migration guide](https://v4.f36.contentful.com/migration-v3-to-v4/) to bump your apps to the new version.
