...
storybook: 'https://v4-f36-storybook.netlify.app/?path=/info/components-typography-typography--displaytext-large'
...
![Typefaces demonstration, San Francisco, Lucida Grande, Neue Helvetica, Arial, and Segoe UI](../../public/typeface.png)
...
![Line-height demonstration against 4px grid](../../public//line-height.png)
