...
For best practices and additional guidance we highly recommend reading [WAI-ARIA Authoring Practices 1.1](https://www.w3.org/TR/wai-aria-practices-1.1/)

### Automated Accessibility Testing

When implementing Forma 36 react components it is important to provide a basic level of automated testing for new components. This is why we use [axe](https://www.deque.com/axe/) and [Jest](https://jestjs.io/) to test component snapshots on WCAG criteria.

Every component bootstrapped using the CLI (e.g. `yarn add-component`) will provide a basic Jest test for accessibility of the component snapshot. More information about testing can be found here: [https://github.com/contentful/forma-36/blob/main/packages/forma-36-react-components/README.md#testing](https://github.com/contentful/forma-36/blob/main/packages/forma-36-react-components/README.md#testing)

## Resources

- [https://www.w3.org/WAI/standards-guidelines/wcag/](https://www.w3.org/WAI/standards-guidelines/wcag/)
- [https://github.com/UKHomeOffice/posters/blob/main/accessibility/dos-donts/posters_en-UK/accessibility-posters-set.pdf](https://github.com/UKHomeOffice/posters/blob/main/accessibility/dos-donts/posters_en-UK/accessibility-posters-set.pdf)
