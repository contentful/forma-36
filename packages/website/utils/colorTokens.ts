...
export const tokens = {
  ...
  datavizCategorical: {
    'dataviz-categorical-1-default': f36Tokens.datavizCategorical1Default,
    'dataviz-categorical-2-default': f36Tokens.datavizCategorical2Default,
    'dataviz-categorical-3-default': f36Tokens.datavizCategorical3Default,
    'dataviz-categorical-4-default': f36Tokens.datavizCategorical4Default,
    'dataviz-categorical-5-default': f36Tokens.datavizCategorical5Default,
    'dataviz-categorical-6-default': f36Tokens.datavizCategorical6Default,
    'dataviz-categorical-7-default': f36Tokens.datavizCategorical7Default,
    'dataviz-categorical-8-default': f36Tokens.datavizCategorical8Default,
    'dataviz-categorical-9-default': f36Tokens.datavizCategorical9Default,
    'dataviz-categorical-10-default': f36Tokens.datavizCategorical10Default,
  },
  datavizCategoricalMuted: {
    'dataviz-categorical-1-muted': f36Tokens.datavizCategorical1Muted,
    'dataviz-categorical-2-muted': f36Tokens.datavizCategorical2Muted,
    'dataviz-categorical-3-muted': f36Tokens.datavizCategorical3Muted,
    'dataviz-categorical-4-muted': f36Tokens.datavizCategorical4Muted,
    'dataviz-categorical-5-muted': f36Tokens.datavizCategorical5Muted,
    'dataviz-categorical-6-muted': f36Tokens.datavizCategorical6Muted,
    'dataviz-categorical-7-muted': f36Tokens.datavizCategorical7Muted,
    'dataviz-categorical-8-muted': f36Tokens.datavizCategorical8Muted,
    'dataviz-categorical-9-muted': f36Tokens.datavizCategorical9Muted,
    'dataviz-categorical-10-muted': f36Tokens.datavizCategorical10Muted,
  },
  datavizSequentialBlue: {
    'dataviz-seq-blue-100': f36Tokens.datavizSeqBlue100,
    'dataviz-seq-blue-300': f36Tokens.datavizSeqBlue300,
    'dataviz-seq-blue-500': f36Tokens.datavizSeqBlue500,
    'dataviz-seq-blue-700': f36Tokens.datavizSeqBlue700,
    'dataviz-seq-blue-900': f36Tokens.datavizSeqBlue900,
  },
  datavizSequentialPurple: {
    'dataviz-seq-purple-100': f36Tokens.datavizSeqPurple100,
    'dataviz-seq-purple-300': f36Tokens.datavizSeqPurple300,
    'dataviz-seq-purple-500': f36Tokens.datavizSeqPurple500,
    'dataviz-seq-purple-700': f36Tokens.datavizSeqPurple700,
    'dataviz-seq-purple-900': f36Tokens.datavizSeqPurple900,
  },
  datavizSequentialTeal: {
    'dataviz-seq-teal-100': f36Tokens.datavizSeqTeal100,
    'dataviz-seq-teal-300': f36Tokens.datavizSeqTeal300,
    'dataviz-seq-teal-500': f36Tokens.datavizSeqTeal500,
    'dataviz-seq-teal-700': f36Tokens.datavizSeqTeal700,
    'dataviz-seq-teal-900': f36Tokens.datavizSeqTeal900,
  },
  datavizSequentialPink: {
    'dataviz-seq-pink-100': f36Tokens.datavizSeqPink100,
    'dataviz-seq-pink-300': f36Tokens.datavizSeqPink300,
    'dataviz-seq-pink-500': f36Tokens.datavizSeqPink500,
    'dataviz-seq-pink-700': f36Tokens.datavizSeqPink700,
    'dataviz-seq-pink-900': f36Tokens.datavizSeqPink900,
  },
  datavizSemantic: {
    'dataviz-chart-gridline': f36Tokens.datavizChartGridline,
    'dataviz-axis-labels': f36Tokens.datavizAxisLabels,
    'dataviz-semantic-positive': f36Tokens.datavizSemanticPositive,
