...
github: 'https://github.com/contentful/forma-36/tree/forma-v4/packages/core/src/Grid'
storybook: 'https://v4-f36-storybook.netlify.app/?path=/story/components-grid--default'
...
`columnGap` represents space between columns, `rowGap` represents the space between rows, both accepts one of [spacing](../tokens/spacing) token names.
...
**Column gap:** The space between vertical containers which corresponds to one of our [spacing](../tokens/spacing) values

**Row gap:** The space between horizontal containers which also corresponds to one of our [spacing](../tokens/spacing) values

![Grid of boxes describing how the grid components (Grid Item, Column Gap, Row Gap, Grid Area) works.](/docs-images/grid_layout.png)
...
<div>
  ...
  >
    <Grid.Item style={{ backgroundColor: '#0C141C', height: '100px' }} />
    <Grid.Item style={{ backgroundColor: '#0C141C', height: '100px' }} />
    <Grid.Item style={{ backgroundColor: '#0C141C', height: '100px' }} />
    <Grid.Item style={{ backgroundColor: '#0C141C', height: '100px' }} />
    <Grid.Item style={{ backgroundColor: '#0C141C', height: '100px' }} />
