...
github: 'https://github.com/contentful/forma-36/tree/main/packages/core/src/Grid'
typescript: ./Grid.tsx,./GridItem/GridItem.tsx
---

`Grid` is a [CSS Grid](https://developer.mozilla.org/en-US/docs/Glossary/Grid) based React component that comes with predefined values to ensure design consistency.
