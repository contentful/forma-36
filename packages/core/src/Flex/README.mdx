...
Flex.Spacer allows you to create an adjustable, empty space that can be used to tune the spacing between child elements within Flex.
...
<Flex>
  ...
  <Box
    padding="spacingM"
    style={{ backgroundColor: tokens.colorGreenBase, color: tokens.colorWhite }}
  >
    Box 2
  </Box>
</Flex>
