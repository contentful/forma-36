...
github: 'https://github.com/contentful/forma-36/tree/main/packages/core/src/Flex'
typescript: ./Flex.tsx
---
...
The `Flex` component is useful because it helps with several common cases: create a one direction layout (vertical or horizontal) with uses Forma 36 [spacing system](/tokens/spacing);
