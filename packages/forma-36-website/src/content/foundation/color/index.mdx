...
import blueColorsDeprecated from '@contentful/forma-36-tokens/src/tokens/colors/colors-blue-deprecated';
...
### This set of namespaces is deprecated, please consider migrating into the new namespaces

<ColorSwatchGroup group={blueColorsDeprecated} />
