...
✅ Button API improvements -> Some of the properties of the Button were migrated or changed. Have a look at the [detailed docs](https://github.com/contentful/forma-36/blob/forma-v4/MIGRATION.md#How-to-migrate-your-Tag-to-Badge) on how to migrate your Tag into Badge in v4
