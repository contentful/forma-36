...
✅ Icon -> Now you can use any icon from our library directly as a component, or wrap an external icon in our `Icon` component to use consistent sizing and styling. Checkout [detailed docs](https://github.com/contentful/forma-36/blob/forma-v4/MIGRATION.md#how-to-migrate-your-icon-components) for more information.

✅ IconButton -> Now you can pass any icon as an element to Icon button component. Checkout [detailed docs](https://github.com/contentful/forma-36/blob/forma-v4/MIGRATION.md#how-to-migrate-your-iconbutton-components) for more information.

✅ Flex -> Some of the properties of the Flex were migrated or changed. Go ahead and check out [detailed docs](https://github.com/contentful/forma-36/blob/forma-v4/MIGRATION.md#how-to-migrate-your-flex-components) on how to migrate your Flex components.

✅ Grid -> Same as for Flex, the main change in version 4 is some properties that were slightly aligned. Go ahead and check out [detailed docs](https://github.com/contentful/forma-36/blob/forma-v4/MIGRATION.md#how-to-migrate-your-grid-components) on how to migrate your Flex components.
