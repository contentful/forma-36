...
2. [Variations](#variations)
   1. [Note type](#note-type)
   2. [Note with title](#note-with-title)
...
### Note with title (`title`) <a name="note-with-title" />
