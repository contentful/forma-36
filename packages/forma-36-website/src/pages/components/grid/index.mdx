...
storybook: 'https://f36-storybook.contentful.com/?path=/story/layout-grid--default'
---
...
![Grid of boxes describing how the grid components (Grid Item, Column Gap, Row Gap, Grid Area) works.](./assets/grid_layout.png)
...
![One dimensional columns without rows describing the use flexbox, and two dimensional grid describes how the grid works](./assets/grid_vs_flexbox.png)
