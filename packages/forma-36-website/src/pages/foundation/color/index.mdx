...
import textColors from '@contentful/f36-tokens/src/tokens/colors/colors-text';
import elementColors from '@contentful/f36-tokens/src/tokens/colors/colors-elements';
import contrastColors from '@contentful/f36-tokens/src/tokens/colors/colors-contrast';
import blueColors from '@contentful/f36-tokens/src/tokens/colors/colors-blue';
import greenColors from '@contentful/f36-tokens/src/tokens/colors/colors-green';
import redColors from '@contentful/f36-tokens/src/tokens/colors/colors-red';
import orangeColors from '@contentful/f36-tokens/src/tokens/colors/colors-orange';
import coralColors from '@contentful/f36-tokens/src/tokens/colors/colors-coral';
import peachColors from '@contentful/f36-tokens/src/tokens/colors/colors-peach';
import mintColors from '@contentful/f36-tokens/src/tokens/colors/colors-mint';
import iceColors from '@contentful/f36-tokens/src/tokens/colors/colors-ice';
