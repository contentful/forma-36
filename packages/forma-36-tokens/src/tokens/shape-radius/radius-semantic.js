...
const radiusSemantic = {
  ...
  // Container radii
  'shape-radius-container-tight': scaleRadius['radius-200'],  // 8px
  'shape-radius-container-small': scaleRadius['radius-300'],  // 12px
  'shape-radius-container-medium': scaleRadius['radius-400'], // 16px
