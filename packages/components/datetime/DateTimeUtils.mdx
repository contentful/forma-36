...
This function will return a formatted string of any date that is passed as the first argument to the function.
...
This function that formats a date relative to Today or to the `baseDate` if passed.
