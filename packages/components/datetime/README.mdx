...
github: 'https://github.com/contentful/forma-36/tree/master/packages/forma-36-react-components/src/components/DateTime'
storybook: 'https://f36-storybook.contentful.com/?path=/story/components-datetime-datetime--basic'
---
...
```ts
import React from 'react';
import { RelativeDate } from '@contentful/f36-datetime';
