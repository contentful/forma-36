...
storybook: 'https://v4-f36-storybook.netlify.app/?path=/story/components-tabs'
...
By default, `Tabs` has no divider, but you can add it by providing `variant` prop for the `Tabs.List`
