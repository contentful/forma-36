...
export const WithButtons: Story = {
  ...
  render: ({ notificationText, duration, ...args }) => {
        ...
        <Flex marginBottom="spacingL">
          <ButtonGroup variant="spaced" spacing="spacingM">
            <Button
              ...
              onClick={() =>
                Notification.success(
                  `${notificationText} ${getUniqueNumber()}`,
                  {
                    duration,
                  },
                )
            ...
            <Button
              ...
              onClick={() =>
                Notification.warning(
                  'Notification that should not be repeated',
                  {
                    duration,
  ...
  render: ({ children, args }) => {
    return (
      <Flex fullWidth flexDirection="column">
        ...
        <Flex marginBottom="spacingL">
          <NotificationItem children={children} {...args} variant="positive" />
        </Flex>
        ...
        <Flex marginBottom="spacingL">
          <NotificationItem children={children} {...args} variant="negative" />
        </Flex>
        ...
        <Flex marginBottom="spacingL">
          <NotificationItem children={children} {...args} variant="warning" />
        </Flex>
        ...
        <Flex marginBottom="spacingL">
          <NotificationItem variant="positive">{children}</NotificationItem>
        </Flex>
      </Flex>
    );
  },
