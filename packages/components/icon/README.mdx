...
<React.Fragment>
  <div>
    <CalendarIcon variant="primary" /> Primary
  </div>
  <div>
    <CalendarIcon variant="positive" /> Positive
  </div>
  <div>
    <CalendarIcon variant="negative" /> Negative
  </div>
  <div>
    <CalendarIcon variant="warning" /> Warning
  </div>
  <div>
    <CalendarIcon variant="secondary" /> Secondary
  </div>
  <div style={{ backgroundColor: '#8091a5' }}>
    <CalendarIcon variant="white" /> White
  </div>
</React.Fragment>
```
...
<React.Fragment>
  <div>
    <CalendarIcon size="tiny" /> Tiny
  </div>
  <div>
    <CalendarIcon size="small" /> Small
  </div>
  <div>
    <CalendarIcon size="medium" /> Medium
  </div>
  <div>
    <CalendarIcon size="large" /> Large
  </div>
</React.Fragment>
```
