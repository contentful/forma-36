...
To offer a shortcut for selecting and deselecting all options, use the property hasSelectAll. This will render a checkbox on top of the list which will trigger the selection and deselection of all elements.
