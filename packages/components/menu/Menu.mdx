...
In most of the cases you will use the controlled approach described [above](#controlled-menu).
But if you have to provide your own toggle menu logic on the trigger component, you can do this by NOT providing `onOpen` callback to the Menu component and providing `onClick` callback on trigger component.
