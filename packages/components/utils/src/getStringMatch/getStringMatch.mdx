...
You can find an example of using `getStringMatch` in [`Autocomplete` component documentation](https://v4.f36.contentful.com/components/autocomplete/#highlighting-an-item-with-getstringmatch)
