...
github: 'https://github.com/contentful/forma-36/tree/main/packages/components/button'
typescript: ./Button.tsx
storybook: 'https://f36-storybook.netlify.app/?path=/story/components-button--basic'
---
