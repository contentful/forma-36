...
typescript: ./src/LegacyPill.tsx
---

> **Deprecated:** This component is deprecated and will be removed in the next major version. Use [`PillNext`](/components/pill-next/) from `@contentful/f36-pill-next` instead.
