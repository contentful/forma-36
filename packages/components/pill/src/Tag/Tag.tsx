...
import type { PillNextVariant } from '../PillNext/PillNext.types';
import { getPillNextStyles } from '../PillNext/PillNext.styles';
...
export type TagInternalProps = CommonProps & {
  ...
  >;
  /** Optional badge rendered between the label and the end icon. */
