...
The `<Typography>` component should be used to wrap a group of typography components (`<Heading>`, `<Text>`, etc) for cases where you wish to display these components with default margins.
