...
type: 'component'
status: 'stable'
slug: /components/step-progress-bar/
github: 'https://github.com/contentful/forma-36/tree/main/packages/components/step-progress-bar'
storybook: 'https://f36-storybook.contentful.com/?path=/story/components-step-progress-bar--default'
...
// or
import { Stepper } from '@contentful/f36-step-progress-bar';
```
