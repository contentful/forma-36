...
github: 'https://github.com/contentful/forma-36/tree/master/packages/components/forms/src/ValidationMessage'
storybook: 'https://f36-storybook.contentful.com/?path=/story/form--elements-validationmessage--default'
typescript: ./ValidationMessage.tsx
---
