...
If you want to allow a user to select only one out of multiple optionsIf you want to let a user select multiple options, use the [Radio](/components/radio) component.
