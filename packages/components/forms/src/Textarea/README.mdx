...
github: 'https://github.com/contentful/forma-36/tree/main/packages/components/forms/src/Textarea'
...
This component also accepts [relevant HTML attributes](https://www.w3.org/wiki/HTML/Elements/textarea) as props. These include `rows`, `autoFocu` and `autoComplete`.
