...
github: 'https://github.com/contentful/forma-36/tree/main/packages/components/forms/src/TextInput'
typescript: ./TextInput.tsx,./input-group/InputGroup.tsx
storybook: 'https://f36-storybook.netlify.app/?path=/story/form-elements-textinput--basic'
---
