...
type: 'component'
status: 'stable'
slug: /components/forms/src/radio/
...
`Radio` is a form component, that shows a checkbox with it's label, if you want to let the user select multiple options, use the `Checkbox` component.
