...
github: 'https://github.com/contentful/forma-36/tree/main/packages/components/forms/src/Radio'
typescript: ./Radio.tsx,./RadioGroup.tsx
storybook: 'https://f36-storybook.netlify.app/?path=/story/form-elements-radio--basic'
---
