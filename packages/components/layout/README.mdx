...
The `Layout` component offers 4 individual areas, they can be set via the props `header`, `leftSidebar` and `rightSidebar` and as `children` for the main content area.
...
** Note ** There will be a seperating Line be displayed underneath the Header if there are Sidebars present. Without Sidebars, there will be no line.
