...
storybook: 'https://v4-f36-storybook.netlify.app/?path=/story/components-collapse'
typescript: ./src/Collapse.tsx,
v4Doc: true
---

import { SectionHeading, Stack, Button } from '@contentful/f36-components';
import { ExternalLinkIcon } from '@contentful/f36-icons';
import { PropsHeading } from '@contentful/f36-docs-utils';
