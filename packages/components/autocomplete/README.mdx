...
It is also possible to use the Autocomplete as multiple select. To improve the user experience, you can keep the dropdown open after selection by setting the "closeAfterSelect" property to false.
