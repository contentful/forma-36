...
function AutocompleteExample() {
  ...
  // we use 'toLowerCase()' to make the search case insentiive
...
- Consider using autocomplete over selects if user will be will be choosing from a very long list, for example a country list.
...
> If you are using Typescript, you can tell the Autocomplete complete what is the type of your items to make this functions strongly typed.
> You can do that by writing the component like this:
>
> `<Autocomplete<ItemType> {...props}/>`
