...
The Navbar offers of multiple areas, which can be targeted via dedicated navbar props and does not accept `children`.
These areas are designed with responsiveness in mind and will appear / disappear on certain breakpoints.
