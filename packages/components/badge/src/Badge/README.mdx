...
```tsx file=../../examples/PrimaryBadgeExample.tsx
...
```tsx file=../../examples/PrimaryFilledBadgeExample.tsx
...
```tsx file=../../examples/PositiveBadgeExample.tsx
...
```tsx file=../../examples/NegativeBadgeExample.tsx
...
```tsx file=../../examples/WarningBadgeExample.tsx
...
```tsx file=../../examples/SecondaryBadgeExample.tsx
...
```tsx file=../../examples/FeaturedBadgeExample.tsx
...
```tsx file=../../examples/DefaultSizeExample.tsx

```

### Small

```tsx file=../../examples/SmallSizeExample.tsx

```

## Icons

An icon can be inserted either to the left and/or the right of the badge by using the `startIcon` and `endIcon` attributes.

**NOTE:** Small badges do not have icons - only the `default` size.

### StartIcon

```tsx file=../../examples/StartIconExample.tsx

```

### EndIcon

```tsx file=../../examples/EndIconExample.tsx
