...
EntityStatusBadge is used to indicate entity status in Contentful apps. A component is based on our [Badge](https://v4.f36.contentful.com/components/badge/) component and has a built-in mapping of entity status to a badge variant.
...
<PropsHeading storybookPath="/story/components-entitystatusbadge" />

<Props of="EntityStatusBadge" />
