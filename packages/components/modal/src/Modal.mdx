...
- [How to use Modal](#how-to-use-modal)
      ...
      <Modal title="Centered modal" isShown={isShown} position={position}>
        {() => (
          <React.Fragment>
            ...
            <Modal.Content>Hello from controlled modal window</Modal.Content>
            <Modal.Controls>
              <Button variant="transparent" onClick={() => setShown(false)}>
                Close
              </Button>
              <Button variant="positive" onClick={() => setShown(false)}>
                Confirm
              </Button>
            </Modal.Controls>
          </React.Fragment>
    ...
    <React.Fragment>
      <Form>
        ...
        >
          ...
          <Option value="333px">333px (specific width value)</Option>
        </SelectField>
        <Button
          onClick={() => {
            setShown(true);
