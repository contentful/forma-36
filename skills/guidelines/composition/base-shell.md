...
Width `240px`, white background, `shadowDefault`, top corners rounded to `12px`.
...
Fills remaining width. White background, `shadowDefault`, top corners rounded to `12px`.
