...
| Token | CSS value | Use |
|---|---|---|
| `shadowDefault` | `0px 0px 0px 1px rgba(25,37,50,.10), 0px 3px 7px -3px rgba(25,37,50,.10), 0px 6px 12px -2px rgba(25,37,50,.10)` | Panels, sidebar, content area, cards |
| `shadowHeavy` | `0px 0px 0px 1px rgba(25,37,50,.10), 0px -6px 16px -6px rgba(25,37,50,.03), 0px 8px 16px -8px rgba(25,37,50,.20), 0px 13px 27px -5px rgba(25,37,50,.15)` | Elevated modals, popovers |
| `shadowButton` | `0px 1px 0px rgb(25,37,50,.10)` | Secondary and transparent buttons |
